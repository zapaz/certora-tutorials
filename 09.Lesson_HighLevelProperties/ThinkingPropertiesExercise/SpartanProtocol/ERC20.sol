...
contract ERC20 is IERC20 {
    ...
    function increase_allowance(address to_user, uint256 inc_amount) external override {
    ...
    function decrease_allowance(address from_user, uint256 dec_amount) external override {
