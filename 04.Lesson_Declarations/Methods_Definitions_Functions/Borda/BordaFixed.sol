...
contract Borda is IBorda {
    ...
    function getFullVoterDetails(address voter)
        ...
        view
        override
        returns (uint8 age, bool registered, bool voted, uint256 vote_attempts, bool blocked)
    {
    ...
    function vote(address first, address second, address third) public override returns (bool) {
        ...
        if (voter_details.voted) {
            require(
                voter_details.vote_attempts >= 3, "you've already voted. If you reach 3 attempts you will be blocked"
            );
